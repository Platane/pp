...
export const questions = [
  ...
  { text: 'How many users do you need to break even?', category: 'business_model' },
  ...
  { text: 'What milestones are you planning to achieve as part of this round?', category: 'metrics' },
  { text: 'What are the potential exits?', category: 'metrics' },
  { text: "What's your scalable aquisition channel to date?", category: 'metrics' },
  { text: 'What can we expect at the back of this round?', category: 'metrics' },
  ...
  { text: "How's your brand part of your overall strategy?", category: 'metrics' },
  ...
  { text: 'How much are you paying your staff, inc yourselves?', category: 'team' },
  ...
  { text: 'Where is your headcount distributerd across departments?', category: 'team' },
].map((x, id) => ({
  ...x,
